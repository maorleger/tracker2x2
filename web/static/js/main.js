...
var _moarwick$elm_webpack_starter$Main$px = function (number) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(number),
		'px');
};
var _moarwick$elm_webpack_starter$Main$updateDrag = F2(
	function (msg, drag) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'DragStart':
				var _p1 = _p0._1;
				return _elm_lang$core$Maybe$Just(
					{id: _p0._0, start: _p1, current: _p1});
			case 'DragAt':
				return A2(
					...
					function (drag) {
						return _elm_lang$core$Native_Utils.update(
							drag,
							{start: drag.start, current: _p0._0});
					},
					drag);
			default:
				return drag;
...
var _moarwick$elm_webpack_starter$Main$toPosition = function (bp) {
	return A2(
		_elm_lang$mouse$Mouse$Position,
...
var _moarwick$elm_webpack_starter$Main$BoundedPosition = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _moarwick$elm_webpack_starter$Main$Story = F4(
	function (a, b, c, d) {
		return {position: a, title: b, description: c, id: d};
	});
var _moarwick$elm_webpack_starter$Main$storyDecoder = function () {
	var setPosition = F2(
		function (position, itemSize) {
			return A2(
				_jschomay$elm_bounded_number$Number_Bounded$set,
				position,
				A2(_jschomay$elm_bounded_number$Number_Bounded$between, 0, _moarwick$elm_webpack_starter$Main$board.width - itemSize));
		});
	var middleY = ((_moarwick$elm_webpack_starter$Main$board.height - _moarwick$elm_webpack_starter$Main$item.height) / 2) | 0;
	var middleX = ((_moarwick$elm_webpack_starter$Main$board.width - _moarwick$elm_webpack_starter$Main$item.width) / 2) | 0;
	return A4(
		_elm_lang$core$Json_Decode$map3,
		_moarwick$elm_webpack_starter$Main$Story(
			{
				x: A2(setPosition, middleX, _moarwick$elm_webpack_starter$Main$item.width),
				y: A2(setPosition, middleY, _moarwick$elm_webpack_starter$Main$item.height)
			}),
	...
	return _elm_lang$http$Http$request(
		{
			...
			url: storiesUrl,
			body: _elm_lang$http$Http$emptyBody,
			expect: _elm_lang$http$Http$expectJson(storiesDecoder),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
};
...
var _moarwick$elm_webpack_starter$Main$init = function (flags) {
	...
	var setPosition = function (position) {
		return A2(
			_jschomay$elm_bounded_number$Number_Bounded$set,
			position,
			A2(_jschomay$elm_bounded_number$Number_Bounded$between, 0, _moarwick$elm_webpack_starter$Main$board.width - _moarwick$elm_webpack_starter$Main$item.width));
	};
	var middleY = ((_moarwick$elm_webpack_starter$Main$board.height - _moarwick$elm_webpack_starter$Main$item.height) / 2) | 0;
	var middleX = ((_moarwick$elm_webpack_starter$Main$board.width - _moarwick$elm_webpack_starter$Main$item.width) / 2) | 0;
	return {
...
var _moarwick$elm_webpack_starter$Main$Token = {ctor: 'Token'};
...
var _moarwick$elm_webpack_starter$Main$StoriesResponse = function (a) {
	return {ctor: 'StoriesResponse', _0: a};
};
var _moarwick$elm_webpack_starter$Main$update = F2(
	function (msg, model) {
		var _p13 = msg;
			...
			case 'DragStart':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							drag: A2(_moarwick$elm_webpack_starter$Main$updateDrag, msg, model.drag)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'DragAt':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								stories: A2(
									_elm_lang$core$List$map,
									A2(_moarwick$elm_webpack_starter$Main$updateStoryPosition, model.axisLock, model.drag),
									model.stories),
								drag: _elm_lang$core$Maybe$Nothing
							}),
						_1: _elm_lang$core$Platform_Cmd$none
...
var _moarwick$elm_webpack_starter$Main$MouseLeave = function (a) {
	return {ctor: 'MouseLeave', _0: a};
};
var _moarwick$elm_webpack_starter$Main$onMouseLeave = function (id) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'mouseleave',
		_elm_lang$core$Json_Decode$succeed(
			_moarwick$elm_webpack_starter$Main$MouseLeave(id)));
};
var _moarwick$elm_webpack_starter$Main$MouseEnter = function (a) {
	return {ctor: 'MouseEnter', _0: a};
};
var _moarwick$elm_webpack_starter$Main$onMouseEnter = function (id) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'mouseenter',
		_elm_lang$core$Json_Decode$succeed(
			_moarwick$elm_webpack_starter$Main$MouseEnter(id)));
};
var _moarwick$elm_webpack_starter$Main$DragEnd = function (a) {
	return {ctor: 'DragEnd', _0: a};
};
var _moarwick$elm_webpack_starter$Main$DragAt = function (a) {
...
var _moarwick$elm_webpack_starter$Main$subscriptions = function (model) {
	...
	if (_p18.ctor === 'Nothing') {
		...
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_moarwick$elm_webpack_starter$Main$DragAt),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_moarwick$elm_webpack_starter$Main$DragEnd),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _moarwick$elm_webpack_starter$Main$DragStart = F2(
	function (a, b) {
		return {ctor: 'DragStart', _0: a, _1: b};
	});
var _moarwick$elm_webpack_starter$Main$onMouseDown = function (id) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'mousedown',
		A2(
			_elm_lang$core$Json_Decode$map,
			_moarwick$elm_webpack_starter$Main$DragStart(id),
			_elm_lang$mouse$Mouse$position));
};
var _moarwick$elm_webpack_starter$Main$itemView = F3(
	function (axisLock, drag, story) {
		var realPosition = _moarwick$elm_webpack_starter$Main$toPosition(
			A3(_moarwick$elm_webpack_starter$Main$getPosition, axisLock, drag, story));
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _moarwick$elm_webpack_starter$Main$onMouseDown(story.id),
					_1: {
						ctor: '::',
						_0: _moarwick$elm_webpack_starter$Main$onMouseEnter(story.id),
						_1: {
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Main$onMouseLeave(story.id),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'left',
											_1: _moarwick$elm_webpack_starter$Main$px(realPosition.x)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'top',
												_1: _moarwick$elm_webpack_starter$Main$px(realPosition.y)
											},
											_1: {
												ctor: '::',
												_0: {
													ctor: '_Tuple2',
													_0: 'width',
													_1: _moarwick$elm_webpack_starter$Main$px(_moarwick$elm_webpack_starter$Main$item.width)
												},
												_1: {ctor: '[]'}
											}
										}
					...
					A2(
						_elm_lang$core$Maybe$withDefault,
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('story_details story_details--empty'),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {ctor: '[]'}
							...
							function (story) {
								return {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('story_details'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('story_details__title'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('story_details__description'),
														_1: {ctor: '[]'}
													},
													A2(_elm_lang$core$Maybe$withDefault, '(no description)', story.description)),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'width',
										_1: _moarwick$elm_webpack_starter$Main$px(_moarwick$elm_webpack_starter$Main$board.width)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'height',
											_1: _moarwick$elm_webpack_starter$Main$px(_moarwick$elm_webpack_starter$Main$board.height)
										},
										_1: {ctor: '[]'}
									}
								}),
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('board__axis board__axis--y'),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('board__axis board__axis--x'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
						...
						A2(
							_elm_lang$core$List$map,
							A2(_moarwick$elm_webpack_starter$Main$itemView, model.axisLock, model.drag),
							model.stories))),
				_1: {ctor: '[]'}
			}
		});
